...
[![Codecov test coverage](https://codecov.io/gh/matryoshkev/microbimixr/graph/badge.svg)](https://app.codecov.io/gh/matryoshkev/microbimixr)
<!-- badges: end -->
...
Make publication-quality figures easily with `plot_strain_fitness()`, `plot_total_fitness()`, and `plot_within_group_fitness()`: 

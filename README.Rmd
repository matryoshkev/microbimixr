...
`microbimixr` provides convenient ways to plot calculated fitness effects. Here's a quick diagnostic plot of the different fitness measures for this dataset: 
```r
...
You can install the development version of `microbimixr` from [GitHub](https://github.com/) with:

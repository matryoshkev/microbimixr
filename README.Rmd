---
title: "microbimixr: Analyze microbial interactions in mix experiments"
...
A common experimental design is to mix together two microbes (different strains of bacteria, for example) then measure how their fitness depends on mix frequency. How do they act differently together than on their own? microbimixr is an R package for analyzing microbial interactions in mix experiments. It helps researchers get the most out of their data by providing tools to:
...
`calculate_mix_fitness()` works with most types of microbial abundance data including cell or virion count, cell or virion density, and genotype frequency. 
...
You can also use the individual axes and other elements of microbimixr plots with ggplot2: 

...
* `plot_total_fitness()` : Plot fitness of total group or subpopulation
* `plot_fitness_ratio()` : Plot within-group ratio of strain fitnesses

These functions let you reproduce the individual subplots from `plot_mix_fitness()`. They're a simple, straight-forward way to make figures designed for fitness data. 
<!-- 
